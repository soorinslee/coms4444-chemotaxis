...
public class Language {
    ...
    public String getState(String color, Integer b) {
        ...
        simPrinter.println("New state is: " + String.valueOf(newState));
        return String.valueOf(newState);
    }

    public String getState(Integer b) {
        return byteToState[b+128];
    }

    public Integer getByte(String s) {
        return stateToByte.get(s);
    }
    ...
    // never change 
    private String[] boxNumToCoords = new String[] {
                        "-1+3",         "+1+3", 
                        "-1+2",         "+1+2", 
    ...
    private String[] byteToState = new String[] {
        // state        i   byte   
        "silent", // 0 / -128
        "pause", // 1 / -127
        "0+1*0+0.R", // 2 / -126
